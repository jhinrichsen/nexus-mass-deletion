...
image::https://img.shields.io/badge/code%20style-gofmt-brightgreen.svg[gofmt, link=https://golang.org/cmd/gofmt/]
...
image::https://goreportcard.com/badge/github.com/jhinrichsen/nexus-mass-deletion[Go Report Card, link=https://goreportcard.com/report/github.com/jhinrichsen/nexus-mass-deletion]
